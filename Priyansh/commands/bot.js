...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "funny") || (event.body.toLowerCase() == "songs")) {
    ...
    if ((event.body.toLowerCase() == "shaan") || (event.body.toLowerCase() == "hamza")) {
   ...
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     ...
     if ((event.body.toLowerCase() == "boss") || (event.body.toLowerCase() == "honey oye")) {
    ...
    if ((event.body.toLowerCase() == "ashii") || (event.body.toLowerCase() == "ayehsa")) {
       ...
       if ((event.body.toLowerCase() == "honey Kon ho ap") || (event.body.toLowerCase() == "honey ap kon ho")) {
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kaha hai")) {     return api.sendMessage("️️️mujhy nahi pata me Honey ki setting hu", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
       return api.sendMessage("༻𝐎𝐖𝐍𝐄𝐑:- ☞ ༻☞[𝐎𝐖𝐍𝐄𝐑:☞➸⃝🐼⃝⃞⃟𝐇𝐚𝐦𝐳𝐚 𝐀𝐥𝐢🎸  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝙎𝙝𝙖𝙖𝙣𝙞. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/𝙈𝙍.𝐇𝐀𝐌𝐙𝐀 345☞    his insta id @Shankhank345 ☜ ༺༒ ༒", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "tera admin kon hai") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
       return api.sendMessage("My admin is 𝐇𝐎𝐍𝐄𝐘 𝐊𝐈𝐍𝐆. He Gives his name mr Shaan everywhare", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "love you")) {     return api.sendMessage("️️️ITNE MUJHE I LOVE YOU BOL RHI HO MERE BOSS HONEY KING URF SALAAR KO BOLO BAHUT HI ACHA BNDA HAI MERA BOSS ", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "🙄")) {return api.sendMessage(" Honey king busy hai mujse bat karo🙄🙄 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😍😍")) {return api.sendMessage("IS NAZAR SE HONEY KING KO DEKHO PYARA NA LAGY PAISE WAPIS 😝😂 ", threadID);
     };
